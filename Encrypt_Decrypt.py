...
def Encrypt(O0OO00OOOOOOOO00O):
    if not O0OO00OOOOOOOO00O or O0OO00OOOOOOOO00O.strip() == '':
        return 'Error'
    ...
    try:
        O0OO00OOOOOOOO00O = base64.b64encode(O0OO00OOOOOOOO00O.encode('utf-8')).decode('utf-8')
        O0OO00OOOOOOOO00O = codecs.encode(O0OO00OOOOOOOO00O, 'rot_13')
    except:
        return 'Error'

    try:
        O0OO00OOOOOOOO00O = ''.join(hex(ord(OOO00000OOOO00OO0))[2:] for OOO00000OOOO00OO0 in O0OO00OOOOOOOO00O)
    except:
        return 'Error'
